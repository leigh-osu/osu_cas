...
trait LinkIconFormatterTrait {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($elements as $key => &$element) {
      ...
      $default = self::defaultSettings()[$key] ?? '';
      $element['#default_value'] = $settings[$key] ?? $default;
    }
    ...
    // D10 doesn't permit markup, theme, to have states:
    // See https://www.drupal.org/project/drupal/issues/2700667.
