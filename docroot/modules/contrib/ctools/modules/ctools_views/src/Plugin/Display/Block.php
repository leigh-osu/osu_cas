...
class Block extends CoreBlock {
  ...
  public function blockForm(ViewsBlock $block, array &$form, FormStateInterface $form_state) {
    ...
    // Ensure the title settings stay together.
    $form['views_label_checkbox']['#weight'] = -20;
    $form['views_label_fieldset']['#weight'] = -20;
    $form['views_label']['#weight'] = -20;
    $form['override']['#weight'] = 20;
