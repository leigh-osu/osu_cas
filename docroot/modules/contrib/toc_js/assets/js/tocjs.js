...
(($) => {
  ...
  function buildToc(tocObj) {
    ...
    if (tocLength >= minimum) {
      ...
      tocObj.tocContainer.classList.add('is-visible');
      tocObj.tocContainer.classList.remove('is-hidden');
      if (tocObj.element !== tocObj.tocContainer) {
        tocObj.element.classList.add('is-visible');
      }
      showBackToTopLinks(tocObj);
    } else {
      tocObj.tocContainer.classList.remove('is-visible');
      tocObj.tocContainer.classList.add('is-hidden');
      if (tocObj.element !== tocObj.tocContainer) {
        tocObj.element.classList.remove('is-visible');
      }
    }
