...
(function ($, Backbone, Drupal, drupalSettings, FloatingUIDOM, undefined) {
  ...
  Drupal.responsivePreview = Drupal.responsivePreview || {
      ...
      TabView: Backbone.View.extend({
        ...
        correctDeviceListEdgeCollision: function () {
          ...
          var floatingElement = this.$el.find('.responsive-preview-item-list')[0];

          FloatingUIDOM.computePosition(referenceElement, floatingElement, {
            placement: 'top-' + edge,
          });
        }
      }),
      ...
      PreviewView: Backbone.View.extend({
        ...
        _refresh: function () {
          ...
          $label
            ...
            .text(Drupal.t('@displayWidth@width by @displayHeight, @orientation', {
  ...
  $.extend(Drupal.theme, {
    ...
    responsivePreviewFrameContainer: function (strings) {
      return '<div id="responsive-preview-frame-container" class="responsive-preview-frame-container" aria-describedby="responsive-preview-frame-label">' +
        ...
        // of the details.
        '<span>&#32;</span>' +
        '<span class="responsive-preview-device-label-details"></span></label>' +
...
}(jQuery, Backbone, Drupal, drupalSettings, FloatingUIDOM, once));
