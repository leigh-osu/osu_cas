...
$settings['config_sync_directory'] = '../config/panorama.anrs.oregonstate.edu';
...
if (file_exists('/var/www/site-php')) {
  ...
  // The Acquia database is named "anrspanorama", not the long form
  ...
  require "/var/www/site-php/{$_ENV['AH_SITE_GROUP']}/anrspanorama-settings.inc";
