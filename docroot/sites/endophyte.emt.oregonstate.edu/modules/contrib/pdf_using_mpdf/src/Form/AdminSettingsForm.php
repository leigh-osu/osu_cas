...
class AdminSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['tab_head'] = [
      '#type' => 'details',
      '#title' => $this->t('Header'),
      '#description' => $this->t('Use {PAGENO} for page numbering or {DATE j-m-Y} for current date. See the full list <a href="@link" target="_blank">here</a>', [
        '@link' => 'https://mpdf.github.io/what-else-can-i-do/replaceable-aliases.html',
      ]),
      '#group' => 'tab',
    ];
    $form['tab_head']['pdf_header'] = [
      ...
      '#description' => $this->t('Use a valid HTML code to write a custom header content. Example: @example', [
    ...
    $form['tab_foot']['pdf_footer'] = [
      ...
      '#description' => $this->t('Use a valid HTML code to write a custom footer content. Example: @example', [
